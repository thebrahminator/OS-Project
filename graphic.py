...
class GraphicScreen(GridLayout):
    ...
    def _prettify_data(self, data):
        dir = "Right" if data[0][2] else "Left"
    ...
    def update_ui(self, results):
        ...
        self.labels.add_widget(Label(text='Method: ' + data['method']))
        self.labels.add_widget(Label(text='Movements: ' + data['movs']))
        self.labels.add_widget(Label(text='Direction: ' + data['dir']))
